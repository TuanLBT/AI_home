...
class PoseConceptLearner:
    ...
    def from_jsonl(
        ...
        With no explicit path, resolve generic episodes + human reviews + old
        teaching examples through TrainingMemory. With a path, read that JSONL
        directly for compatibility/debugging.
        """
        if path is None:
    ...
    def predict_episode(self, episode: LearningEpisode) -> dict[str, Any] | None:
        ...
        return self.predict(frame_vectors)
